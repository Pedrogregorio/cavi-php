<?php  
	...
	include_once("conexao.php");
			...
			if(array_search($extensao, $_UP['extensoes'])=== false){		
				$_SESSION['msg_at'] = "Imovel Imagem nao cadastrada: Extensão Invalida";
					header('location: ../../edcao.php');
				// echo "
			...
			//Faz a verificação do tamanho do arquivo
				...
				$_SESSION['msg_at'] = "Arquivo muito Grande!";
					header('location: ../../edcao.php');
				// echo "
				// 	<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/TCC-CAVI2/BD/edcao.php'>
				// 	<script type=\"text/javascript\">
			...
			//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
				...
				if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta']. $nome_final)){
					...
					$_SESSION['msg_at'] = "Imovel atualizado com Sucesso!";
					header('location: ../../edcao.php');
					// echo "
					...
					$_SESSION['msg_at'] = "Imovel nao atualizado!";
					header('location: ../../edcao.php');
